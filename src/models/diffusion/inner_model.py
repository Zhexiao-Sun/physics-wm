...
class InnerModel(nn.Module):
    def __init__(self, cfg: InnerModelConfig) -> None:
        ...
        in_channels = (cfg.num_steps_conditioning + int(cfg.is_upsampler) + 1) * cfg.img_channels + cfg.extra_cond_channels   # mask concat
        self.conv_in = Conv3x3(in_channels, cfg.channels[0])
        # conv_in = Conv2d(16, 128, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
